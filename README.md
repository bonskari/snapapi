...
**[Get your free API key →](https://api.usesnapapi.com)** | **[API Docs →](https://api.usesnapapi.com/docs)**
...
Need more? [Contact us](mailto:hello@usesnapapi.com) for custom plans.
...
# Screenshot
resp = requests.post("https://api.usesnapapi.com/v1/screenshot", headers=headers, json={
...
Built by [Unstable Entity Oy](https://usesnapapi.com) — a Finnish software company building developer tools.
